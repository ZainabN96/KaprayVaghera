					...
					<div class="header-search expand">
						...
						<form action="search.php" id="searchform" method="get" class="sreach custom-search-form">
							<div class="input-group">
								<input type="text" class="srearh custom-search-input form-control" style="width: 550px; border-radius:39px; padding:25px;" placeholder="Search product..." name="str">
	...
	<div class="container-fluid ">
		<div class="row">
			<div class="col-lg-12 text-center">
				...
				<!-- mobile menu start -->
				<div class="row">
					<div class="col-sm-12 mobile-menu-area bg-black">
						<div class="mobile-menu hidden-md d-lg-none" id="mob-menu">
							<span class="mobile-menu-title">Menu</span>
							<a href="javascript:void(0);" class="openNav align-content-right">
