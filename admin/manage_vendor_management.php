...
if (isset($_POST['submit'])) {
	...
	if ($msg == '') {
		if (isset($_GET['id']) && $_GET['id'] != '') {
			$update_sql = "update admin_users set username='$username',password='$password',email='$email',mobile='$mobile',role='$role' where id='$id'";
...
<div class="content pb-0">
	<div class="animated fadeIn">
		<div class="row">
			<div class="col-lg-12">
				<div class="card">
					<div class="card-header"><strong>ADD User Type</strong><small> Form</small></div>
						...
						<div class="card-body card-block">
							...
							<div class="form-group">
								...
								<select id="role" name="role" class="form-control" required>
									...
									<option value="Order Team">Order Team</option>
								</select>
							</div>
