                                                ...
                                                <div class="col-md-6">
                                                    <div class="checkout-method__login">
                                                        <form id="login-form" method="post">
                                                            ...
                                                            <div class="dark-btn">
                                                                <button type="button" class="btn btn-primary btn-lg" onclick="user_login()">Login</button>
                                                            </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="checkout-method__login">
                                                        <form action="#">
                                                            ...
                                                            <div class="dark-btn">
                                                                <button type="button" class="btn btn-primary btn-lg" onclick="user_register()">Register</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
