				...
				<!-- <div class="row">
					<div class="col-lg-3 col-md-6">
						<div class="item-team text-center">
							<div class="team-info">
								<div class="team-img">
									<img src="img/about/ab-team1.webp" class="img-responsive" alt="team1" height="600" width="600">
									<div class="mask">
					...
					<!-- <div class="col-lg-3 col-md-6">
						<div class="item-team text-center">
							<div class="team-info">
								<div class="team-img">
									<img src="img/about/ab-team2.webp" class="img-responsive" alt="team2" height="601" width="600">
									<div class="mask">
										<div class="mask-inner">
											<a href="#"><i class="fa fa-facebook"></i></a>
											<a href="#"><i class="fa fa-twitter"></i></a>
					...
					<!-- <div class="col-lg-3 col-md-6">
						<div class="item-team text-center">
							<div class="team-info">
								<div class="team-img">
									<img src="img/about/ab-team3.webp" class="img-responsive" alt="team3" height="600" width="600">
									<div class="mask">
										<div class="mask-inner">
											<a href="#"><i class="fa fa-facebook"></i></a>
											<a href="#"><i class="fa fa-twitter"></i></a>
					...
					<!-- <div class="col-lg-3 col-md-6">
						<div class="item-team text-center">
							<div class="team-info">
								<div class="team-img">
									<img src="img/about/ab-team4.webp" class="img-responsive" alt="team4" height="600" width="600">
									<div class="mask">
										<div class="mask-inner">
											<a href="#"><i class="fa fa-facebook"></i></a>
											<a href="#"><i class="fa fa-twitter"></i></a>
